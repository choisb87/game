...
func _apply_skin() -> void:
	...
	title_label.label_settings = _label_settings(52, ACCENT_TEXT)
	progress_label.label_settings = _label_settings(19, SOFT_TEXT)
	subtitle_label.label_settings = _label_settings(24, BODY_TEXT)
	objective_label.label_settings = _label_settings(22, BODY_TEXT)
	level_label.label_settings = _label_settings(22, SOFT_TEXT)
	move_label.label_settings = _label_settings(22, SOFT_TEXT)
	status_label.label_settings = _label_settings(22, BODY_TEXT)
	hint_label.label_settings = _label_settings(23, BODY_TEXT)
	feedback_label.label_settings = _label_settings(21, BODY_TEXT)
	menu_eyebrow.label_settings = _label_settings(18, SOFT_TEXT)
	menu_title.label_settings = _label_settings(42, ACCENT_TEXT)
	menu_text.label_settings = _label_settings(24, BODY_TEXT)
	menu_rules.label_settings = _label_settings(21, SOFT_TEXT)
	result_eyebrow.label_settings = _label_settings(18, SOFT_TEXT)
	result_title.label_settings = _label_settings(34, ACCENT_TEXT)
	result_text.label_settings = _label_settings(22, BODY_TEXT)

	menu_button.custom_minimum_size = Vector2(0, 72)
	restart_button.custom_minimum_size = Vector2(0, 72)
	menu_secondary_button.custom_minimum_size = Vector2(0, 72)
	start_button.custom_minimum_size = Vector2(0, 72)
	result_secondary_button.custom_minimum_size = Vector2(0, 72)
	result_primary_button.custom_minimum_size = Vector2(0, 72)
